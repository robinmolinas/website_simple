...
export const PROJECTS: Project[] = [
  {
    ...
    role: [
      ...
      'Engineered index-based retrieval where the query engine reads a content catalog (index.md) first, then drills into linked pages, deliberately avoiding embedding/vector-DB infrastructure, which is unnecessary at this scale (63 sources)',
    ...
    impact: [
      'Replaces query-time RAG with a knowledge layer that compounds, where every source added makes the whole system richer, not just larger',
      'Surfaces cross-domain connections that linear report-reading and chunk-retrieval both miss, which is the actual source of strategic insight',
  ...
  },
  {
    ...
    intro:
      "Every promise L'Oréal makes on a pack, a page, or an ad starts as a claim. The process behind those claims ran on siloed tools and manual handoffs between teams that rarely talked, while indie brands and K-Beauty disruptors shipped bolder claims faster. I led product design and AI strategy for Power Claims, a unified platform covering the full claims lifecycle: competitive intelligence, brief creation, scientific substantiation, regulatory review, and local activation. The MVP launched on skincare across eight pilot countries, with an ecosystem of AI agents orchestrating the flow across five modules, each built around how a specific user actually works, from global marketers to regulatory reviewers to local teams.",
    metrics: [
      ['130+', 'champions trained on the new process'],
      ['11', 'countries in Claim Committee rollout'],
      ['8', 'pilot countries at MVP launch'],
      ['3', 'skincare pilot projects live on the platform'],
    ],
    role: [
      'Sole design and AI strategy lead, from vision through MVP delivery and the post-MVP roadmap',
      'Designed the end-to-end claims lifecycle architecture across five modules: Claim Knowledge, Claim Project, Predict Claim, Risk Escalation, and Claim Dossier',
      'Architected an ecosystem of 20+ AI agents, from an orchestrator that drafts full claim lists to specialists scoring consumer relevancy, competitive whitespace, scientific grounding, and regulatory risk',
      'Prototyped the entire claims pipeline as a working agent system before platform engineering began, de-risking the AI architecture with real dossiers and real users',
      'Designed role-specific workflows so five very different users, marketers, regulators and scientists among them, could collaborate in one tool without drowning in each other\'s noise',
      'Connected competitive and consumer intelligence (Mintel, Revuze, TalkWalker, internal insight platforms) so claims start from market evidence, not intuition',
      'Defined the scaling roadmap: deeper AI consolidation, wider process coverage, and expansion across categories and divisions',
    ],
    impact: [
      'Selected as L\'Oréal\'s global claims transformation backbone, replacing fragmented legacy tooling',
      'Agent architecture adopted as the reference model for L\'Oréal Beauty Tech\'s agentic platform',
      '130+ R&I and marketing champions trained, 3 pilot projects onboarded, rollout underway in 11 priority countries',
      'Scaling path defined across L\'Oréal\'s divisions through 2027, built to deliver on three goals: bolder claims, faster time to claim, smarter collaboration',
    ],
  ...
  },
  {
    ...
    name: "SONGAI\nGENAI PLATFORM",
    description:
      "Led the product strategy for Accenture Song’s global GenAI platform, transforming fragmented AI experimentation into a modular creative operating system for research, strategy, content, and delivery.",
    buttonLabel: 'Learn more →',
    client: 'Accenture Song · Global Internal Platform',
    tags: ['GenAI Strategy', 'Marketing reinvention', 'Platform design'],
    competencies: [
      'GenAI Strategy',
      'Product Strategy',
      'Platform Design',
    ...
    intro:
      "THE CHALLENGE:\nCreative teams were experimenting with GenAI everywhere, but value was fragmented. Tools were scattered. Workflows were disconnected. Knowledge was hard to reuse. Practitioners needed one trusted place to research, ideate, create, and deliver with AI at scale.\n\nTHE IDEA:\nSongAI was designed as a modular GenAI platform for Accenture Song. Not another isolated tool, but a creative operating system connecting proprietary assets, third-party AI tools, project knowledge, and end-to-end workflows into one unified experience.",
    role: [
      'Led the product strategy and concept development from discovery through Alpha launch',
      'Conducted practitioner research, mapped opportunity spaces, and defined platform positioning',
      'Orchestrated module definition, roadmap prioritization, workflow design, and launch activities',
      'Built modular AI applications for research, content, ideation, testing, design, and delivery',
      'Designed pre-built workflows connecting AI modules into repeatable, standardized ways of working',
      'Shaped the conversational interface for frictionless access to tools, project knowledge, and intelligence',
      'Established a scalable architecture integrating internal capabilities and third-party AI tools',
    ],
    impact: [
      'Shifted GenAI adoption from isolated experimentation to scalable, operational transformation',
      'Created a unified operating system replacing a fragmented, disconnected GenAI tooling landscape',
      'Provided creative teams with a structured, intuitive way to leverage AI across the entire creative lifecycle',
      'Amplified human judgment, research, strategy, creativity, and delivery through secure, modular intelligence',
    ],
    metrics: [
      ['70+', 'practitioner interviews across roles, practices, and markets'],
      ['30+', 'GenAI opportunity areas mapped across the creative value chain'],
      ['10', 'high-priority modules defined for the roadmap'],
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: '/leopards.gif', label: 'Arabian Leopard' },
      { src: '/roblox_game.gif', label: 'Roblox World' },
    ],
  },
];
